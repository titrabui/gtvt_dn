				...
				<div class="row">
					<div class="col-lg-6 col-md-6">
						<?php if (count($measuring_values) > 0) { ?>
							<?php echo Form::open(array(
								'name'   => 'monthform',
								'method' => 'get',
								'action' => 'user/measuring_values/view/'.$measuring_points['project_id'],
					...
					<div class="col-lg-6 col-md-6">
						<div class="text-right">
							<a class="btn btn-md btn-primary" href="<?php echo Uri::create('user/measuring_points/view/'.$measuring_points['project_id']); ?>">

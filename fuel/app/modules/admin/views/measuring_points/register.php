		...
		<div class="box box-primary box-solid">
			...
			<div class="box-body">
				...
				<?php echo Form::open(array(
					'name'   => 'registerform',
					'method' => 'post',
					'action' => 'admin/measuring_points/register?project='.$project_id,
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" class="form-control" id="location" name="location" value="<?php echo Input::post('location', $location); ?>" placeholder="Vị trí">
						</div>
					</div>
					<div class="form-group">

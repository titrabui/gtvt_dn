				...
				<div class="row">
					<div class="col-lg-6 col-md-6">
						<?php if (count($measuring_values) > 0) { ?>
							<?php echo Form::open(array(
								'name'   => 'monthform',
								'method' => 'get',
								'action' => 'moderator/measuring_values/view/'.$measuring_points['id'],
					...
					<div class="col-lg-6 col-md-6">
						<div class="text-right">
							...
							<?php if (count($measuring_values) > 0) { ?>
								<a class="btn btn-md btn-primary" href="<?php echo Uri::create('moderator/measuring_values/report/'.$measuring_points['id'].'?month_selected='.$month_selected); ?>">
